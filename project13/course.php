...
<body>
    ...
    $courses1 = [
        ...
        [
            'title' => 'LẬP TRÌNH VIÊN QUỐC TẾ',
            'image' => 'assets\image\1200x628-4-.png',
            'description' => 'Chương trình đào tạo chuẩn quốc tết và toàn diện. Phù hợp với học sinh tốt nghiệp THPT, sinh viên và người định hướng theo nghề lập trình chuyên nghiệp.',
            'fee' => '15.000.000 VNĐ',
            'start_date'=> '2/2/2024',
            'duration'=> '2-2.5 năm'
        ...
        [
            'title' => 'LẬP TRÌNH VIÊN QUỐC TẾ',
            'image' => 'assets\image\baiviet-tkw.jpg',
            'description' => 'Chương trình đào tạo chuẩn quốc tết và toàn diện. Phù hợp với học sinh tốt nghiệp THPT, sinh viên và người định hướng theo nghề lập trình chuyên nghiệp.',
            'fee' => '15.000.000 VNĐ',
            'start_date'=> '2/2/2024',
            'duration'=> '2-2.5 năm'
...
<!--    Hiến thị danh sách khóa học-->
    ...
    $courses2 = [
        [
            'title' => 'LẬP TRÌNH VIÊN QUỐC TẾ',
            'image' => 'assets\image\banner2-848x548.png',
            'description' => 'Chương trình đào tạo chuẩn quốc tết và toàn diện. Phù hợp với học sinh tốt nghiệp THPT, sinh viên và người định hướng theo nghề lập trình chuyên nghiệp.',
            'fee' => '15.000.000 VNĐ',
            'start_date'=> '2/2/2024',
            'duration'=> '2-2.5 năm'
        ...
        [
            'title' => 'LẬP TRÌNH VIÊN QUỐC TẾ',
            'image' => 'assets\image\lập-trình-web-min.png',
            'description' => 'Chương trình đào tạo chuẩn quốc tết và toàn diện. Phù hợp với học sinh tốt nghiệp THPT, sinh viên và người định hướng theo nghề lập trình chuyên nghiệp.',
            'fee' => '15.000.000 VNĐ',
            'start_date'=> '2/2/2024',
            'duration'=> '2-2.5 năm'
